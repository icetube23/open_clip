...
def parse_args(args):
    ...
    parser.add_argument(
        "--dataset-type",
        choices=["webdataset", "csv", "synthetic", "cc12m", "cc12m_web", "auto"],
        default="auto",
    ...
    # parser.add_argument(
    #     "--save-frequency-step", type=int, default=None, help="How often to save checkpoints."
    # )
    parser.add_argument(
        "--save-log-step", action="store_true", help="How often to save checkpoints."
    )
    parser.add_argument(
        "--save-most-recent",
        action="store_true",
